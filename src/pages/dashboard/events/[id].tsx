...
export default function Event() {
    ...
    const event = api.event.get.useQuery({ id: router.query.id as string })
    return (
        <>
            <Head>
            ...
            <div className="w-[99vw]">
                <section className="flex flex-row mt-5 justify-center">
                    ...
                    <div className="flex flex-col justify-center items-center w-auto">
                        ...
                        <p className="text-md text-muted-foreground w-1/2 mb-1">{event.data?.date.toDateString()} • Organized by Name 1, Name 2, Name 3</p>
                        ...
                        <p className="text-md text-muted-foreground w-1/2">Lorem ipsum dolor sit amet lorem ipsum dolor sit amet lorem ipsum dolor sit amet lorem ipsum dolor sit amet lorem ipsum dolor sit amet</p>
                        <Button
