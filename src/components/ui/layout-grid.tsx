        ...
        <div key={i} className={cn(card.className, "")}>
          <motion.div
            ...
            className={cn(
              ...
              selected?.id === card.id
                ? "rounded-lg cursor-pointer fixed left-0 right-0 mx-auto inset-0 h-1/2 w-full md:w-1/2 m-auto z-50 flex justify-center items-center flex-wrap flex-col"
  ...
  return (
    <div className="bg-transparent h-full w-full flex flex-col justify-end rounded-lg  relative z-[60]">
      ...
      <motion.div
        ...
        className="fixed px-8 pb-4 z-[70]"
      >
        {selected?.content}
      </motion.div>
    </div>
