...
> extends React.HTMLAttributes<HTMLDivElement> {
  ...
  submitUploadFiles: (files: FileWithPreview[]) => Promise<void> | void;
  accept?: Accept;
  maxSize?: number;
  maxFiles?: number;
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-xl">
        ...
        <div
          {...getRootProps()}
          className={cn(
            "group relative mt-8 grid h-[30vh] w-full cursor-pointer place-items-center rounded-lg border-2 border-dashed border-muted-foreground/25 px-5 py-2.5 text-center transition hover:bg-muted/25",
